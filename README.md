...
All the code samples in this post are included here. Files with the suffix `_final` are the final, complete code samples. Files with the suffix `_partial` are the partial code samples, generated by GitHub Copilot.
